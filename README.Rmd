...
This operation can take a few minutes, depending on your internet speed. You should only need to do it once, though.
...
Note that the app starts in a browser window. The `R` console remains busy while the app is running. Use `Ctrl-C` to quit the process and get your console back.
